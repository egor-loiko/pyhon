...
class PythonOrgSearch(unittest.TestCase):
    ...
    def test_login_logout(self):
        ...
        elem = driver.find_element("link text","Sign In")  # нажатие на ссылку
        elem.click()
        # ждем 5 секунд
        time.sleep(5)
        ...
        #elem = driver.find_element("link text", "Sign out")
        # нажатие на ссылку
       # elem.click()
    ...
    def test_about_breadcrumbs(self):
        ...
        elems = driver.find_element("css selector", "#about ul li a")
